...
- <code title="get /projects/{projectId}/nodes">client.projects.<a href="./src/resources/projects/projects.ts">listNodes</a>(projectID, { ...params }) -> ProjectListNodesResponse</code>

## Assets

Types:

- <code><a href="./src/resources/projects/assets.ts">AssetAttachResponse</a></code>

Methods:

- <code title="post /projects/{projectId}/assets/{assetId}/attach">client.projects.assets.<a href="./src/resources/projects/assets.ts">attach</a>(assetID, { ...params }) -> AssetAttachResponse</code>
...
- <code title="get /techniques">client.techniques.<a href="./src/resources/techniques/techniques.ts">list</a>({ ...params }) -> TechniqueListResponse</code>
...
- <code><a href="./src/resources/techniques/runs.ts">RunStartResponse</a></code>
...
- <code title="post /techniques/{techniqueId}/runs">client.techniques.runs.<a href="./src/resources/techniques/runs.ts">start</a>(techniqueID, { ...params }) -> RunStartResponse</code>
...
- <code><a href="./src/resources/assets.ts">AssetCompleteUploadResponse</a></code>
- <code><a href="./src/resources/assets.ts">AssetRetryUploadResponse</a></code>
...
- <code title="post /assets/{assetId}/complete">client.assets.<a href="./src/resources/assets.ts">completeUpload</a>(assetID) -> AssetCompleteUploadResponse</code>
- <code title="post /assets/{assetId}/retry">client.assets.<a href="./src/resources/assets.ts">retryUpload</a>(assetID) -> AssetRetryUploadResponse</code>
