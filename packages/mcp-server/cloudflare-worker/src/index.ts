...
import { McpOptions } from 'flora-mcp/options';
import { initMcpServer, newMcpServer } from 'flora-mcp/server';
import { configureLogger } from 'flora-mcp/logger';
...
function fallbackMcpServer(): McpServer {
  return new McpServer(
    { name: 'flora_ai_flora_api', version: '0.5.0' },
