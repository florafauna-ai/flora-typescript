...
const fuse = new Fuse(
  [
    ...
    'client.techniques.retrieve',
    'client.techniques.runs.create',
    'client.techniques.runs.list',
    'client.techniques.runs.retrieve',
    ...
    'client.workspaces.projects.graph',
    'client.workspaces.projects.runNodes',
    'client.workspaces.projects.canvas.applyChangeset',
    'client.workspaces.projects.canvas.replaceDefinition',
    'client.workspaces.projects.canvas.retrieveDefinition',
    'client.workspaces.folders.createProject',
    'client.workspaces.library.folders.addItem',
    'client.workspaces.library.folders.create',
    'client.workspaces.library.folders.delete',
    'client.projects.create',
    'client.projects.list',
    'client.projects.listNodes',
    'client.projects.retrieve',
    'client.projects.assets.attachAsset',
    'client.projects.canvas.retrieve',
    'client.projects.canvas.update',
    'client.projects.actions.create',
    'client.projects.actions.run',
    'client.actions.list',
    'client.actions.retrieve',
    'client.actions.run',
    'client.models.list',
    'client.runs.startGeneration',
