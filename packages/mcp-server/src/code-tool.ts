...
import { ClientOptions } from 'flora';
...
const remoteStainlessHandler = async ({
  ...
  const localClientEnvs = {
    FLORA_API_KEY: readEnv('FLORA_API_KEY') ?? client.apiKey ?? undefined,
    FLORA_BASE_URL: readEnv('FLORA_BASE_URL') ?? client.baseURL ?? undefined,
  };
