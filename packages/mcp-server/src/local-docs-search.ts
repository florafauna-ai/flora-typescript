...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## start_generation\n\n`client.runs.startGeneration(body: object): { charged_cost: number; estimated_seconds: number; run_id: string; type: 'generation' | 'technique'; workflow_run_id: string; model?: object; poll_url?: string; project_id?: string; technique?: object; }`\n\n**post** `/runs/generation`\n\nStarts a model generation run in a project canvas using a prompt, workspace, project, optional model, and optional model parameters. Mutating public API requests support an optional Idempotency-Key header for client retries; duplicate keys within two hours return idempotency_duplicate.\n\n### Parameters\n\n- `body: object`\n\n### Returns\n\n- `{ charged_cost: number; estimated_seconds: number; run_id: string; type: 'generation' | 'technique'; workflow_run_id: string; model?: { model_id: string; }; poll_url?: string; project_id?: string; technique?: { name: string; technique_id: string; }; }`\n\n  - `charged_cost: number`\n  - `estimated_seconds: number`\n  - `run_id: string`\n  - `type: 'generation' | 'technique'`\n  - `workflow_run_id: string`\n  - `model?: { model_id: string; }`\n  - `poll_url?: string`\n  - `project_id?: string`\n  - `technique?: { name: string; technique_id: string; }`\n\n### Example\n\n```typescript\nimport Flora from '@flora-ai/flora';\n\nconst client = new Flora();\n\nconst response = await client.runs.startGeneration({ body: {} });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ charged_cost: number; estimated_seconds: number; run_id: string; type: 'generation' | 'technique'; workflow_run_id: string; model?: { model_id: string; }; poll_url?: string; project_id?: string; technique?: { name: string; technique_id: string; }; }",
    markdown:
      "## start_technique\n\n`client.runs.startTechnique(body: object): { charged_cost: number; estimated_seconds: number; run_id: string; type: 'generation' | 'technique'; workflow_run_id: string; model?: object; poll_url?: string; project_id?: string; technique?: object; }`\n\n**post** `/runs/technique`\n\nStarts a technique run through the normalized top-level run resource. Mutating public API requests support an optional Idempotency-Key header for client retries; duplicate keys within two hours return idempotency_duplicate.\n\n### Parameters\n\n- `body: object`\n\n### Returns\n\n- `{ charged_cost: number; estimated_seconds: number; run_id: string; type: 'generation' | 'technique'; workflow_run_id: string; model?: { model_id: string; }; poll_url?: string; project_id?: string; technique?: { name: string; technique_id: string; }; }`\n\n  - `charged_cost: number`\n  - `estimated_seconds: number`\n  - `run_id: string`\n  - `type: 'generation' | 'technique'`\n  - `workflow_run_id: string`\n  - `model?: { model_id: string; }`\n  - `poll_url?: string`\n  - `project_id?: string`\n  - `technique?: { name: string; technique_id: string; }`\n\n### Example\n\n```typescript\nimport Flora from '@flora-ai/flora';\n\nconst client = new Flora();\n\nconst response = await client.runs.startTechnique({ body: {} });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
