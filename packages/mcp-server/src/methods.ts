...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.workspaces.projects.create',
    fullyQualifiedName: 'workspaces.projects.create',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/projects',
  },
  {
    clientCallName: 'client.workspaces.projects.graph',
    fullyQualifiedName: 'workspaces.projects.graph',
    httpMethod: 'get',
    httpPath: '/workspaces/{workspaceId}/projects/{projectId}/graph',
  },
  {
    clientCallName: 'client.workspaces.projects.runNodes',
    fullyQualifiedName: 'workspaces.projects.runNodes',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/projects/{projectId}/nodes/run',
  },
  {
    clientCallName: 'client.workspaces.projects.canvas.applyChangeset',
    fullyQualifiedName: 'workspaces.projects.canvas.applyChangeset',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/projects/{projectId}/canvas/changeset',
  },
  {
    clientCallName: 'client.workspaces.projects.canvas.replaceDefinition',
    fullyQualifiedName: 'workspaces.projects.canvas.replaceDefinition',
    httpMethod: 'put',
    httpPath: '/workspaces/{workspaceId}/projects/{projectId}/canvas/definition',
  },
  {
    clientCallName: 'client.workspaces.projects.canvas.retrieveDefinition',
    fullyQualifiedName: 'workspaces.projects.canvas.retrieveDefinition',
    httpMethod: 'get',
    httpPath: '/workspaces/{workspaceId}/projects/{projectId}/canvas/definition',
  },
  {
    clientCallName: 'client.workspaces.folders.createProject',
    fullyQualifiedName: 'workspaces.folders.createProject',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/folders/{folderId}/projects',
  },
  {
    clientCallName: 'client.workspaces.library.folders.create',
    fullyQualifiedName: 'workspaces.library.folders.create',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/library/folders',
  },
  {
    clientCallName: 'client.workspaces.library.folders.delete',
    fullyQualifiedName: 'workspaces.library.folders.delete',
    httpMethod: 'delete',
    httpPath: '/workspaces/{workspaceId}/library/folders/{folderId}',
  },
  {
    clientCallName: 'client.workspaces.library.folders.addItem',
    fullyQualifiedName: 'workspaces.library.folders.addItem',
    httpMethod: 'post',
    httpPath: '/workspaces/{workspaceId}/library/folders/{folderId}/items',
  },
  {
