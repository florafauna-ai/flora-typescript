...
export interface RetrieveGenerationsResponse {
    /** Run identifier */
    run_id: string;
    status: RetrieveGenerationsResponse.Status;
    progress: number;
    created_at: number;
    ...
    outputs?: RetrieveGenerationsResponse.Outputs.Item[] | undefined;
    /** URL to poll pending/running runs or fetch completed/failed run details. */
    poll_url?: string | undefined;
}

export namespace RetrieveGenerationsResponse {
    export const Status = {
        Pending: "pending",
        Running: "running",
        Completed: "completed",
