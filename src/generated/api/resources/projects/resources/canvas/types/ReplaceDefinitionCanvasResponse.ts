...
export interface ReplaceDefinitionCanvasResponse {
    /** Project identifier */
    project_id: string;
    /** Project canvas URL */
    canvas_url: string;
    definition: ReplaceDefinitionCanvasResponse.Definition;
    summary: ReplaceDefinitionCanvasResponse.Summary;
}

export namespace ReplaceDefinitionCanvasResponse {
