...
export interface CreateRunsResponse {
    /** Run identifier */
    run_id: string;
    status: CreateRunsResponse.Status;
    progress: number;
    created_at: number;
